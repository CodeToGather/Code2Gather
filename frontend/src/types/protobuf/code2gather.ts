  ...
  export class JoinRoomResponse extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.question !== undefined)
        writer.writeMessage(4, this.question, () =>
  ...
  export class CompleteQuestionResponse extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.next_question !== undefined)
        writer.writeMessage(4, this.next_question, () =>
          this.next_question.serialize(writer),
        );
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 4:
            reader.readMessage(
              ...
              () =>
                (message.next_question = QuestionMessage.deserialize(reader)),
            );
            break;
          case 5:
