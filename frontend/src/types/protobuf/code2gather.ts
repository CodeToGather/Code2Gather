...
export namespace code2gather {
  ...
  export class QuestionMessage extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.difficulty !== undefined) writer.writeEnum(4, this.difficulty);
    ...
    static override deserializeBinary(bytes: Uint8Array): QuestionMessage {
  ...
  export class RoomMessage extends pb_1.Message {
    ...
    static override deserializeBinary(bytes: Uint8Array): RoomMessage {
  ...
  export class User extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (typeof this.id === 'string' && this.id.length)
        writer.writeString(1, this.id);
      if (
        typeof this.github_username === 'string' &&
        this.github_username.length
      )
  ...
  export class CreateRoomRequest extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.difficulty !== undefined) writer.writeEnum(3, this.difficulty);
      if (!w) return writer.getResultBuffer();
    }
    static deserialize(
    ...
    static override deserializeBinary(bytes: Uint8Array): CreateRoomRequest {
  ...
  export class CreateRoomResponse extends pb_1.Message {
    ...
    static fromObject(data: { room_id?: string }) {
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new CreateRoomResponse();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
    ...
    static override deserializeBinary(bytes: Uint8Array): CreateRoomResponse {
  ...
  export class CheckInRoomRequest extends pb_1.Message {
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new CheckInRoomRequest();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          default:
    ...
    static override deserializeBinary(bytes: Uint8Array): CheckInRoomRequest {
  ...
  export class CheckInRoomResponse extends pb_1.Message {
    ...
    static fromObject(data: { is_in_room?: boolean; room_id?: string }) {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.is_in_room !== undefined) writer.writeBool(1, this.is_in_room);
      if (typeof this.room_id === 'string' && this.room_id.length)
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new CheckInRoomResponse();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
    ...
    static override deserializeBinary(bytes: Uint8Array): CheckInRoomResponse {
      return CheckInRoomResponse.deserialize(bytes);
    }
  }
  export class GetQuestionResponse extends pb_1.Message {
    constructor(
      data?:
        | any[]
        | {
    ...
    static fromObject(data: {
      ...
      const message = new GetQuestionResponse({});
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.question !== undefined)
        writer.writeMessage(1, this.question, () =>
          this.question.serialize(writer),
        );
      if (!w) return writer.getResultBuffer();
    }
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new GetQuestionResponse();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
            reader.readMessage(
              message.question,
              () => (message.question = QuestionMessage.deserialize(reader)),
            );
            break;
          default:
            reader.skipField();
    ...
    static override deserializeBinary(bytes: Uint8Array): GetQuestionResponse {
      return GetQuestionResponse.deserialize(bytes);
    }
  }
  export class CreateMeetingRequest extends pb_1.Message {
    constructor(
      ...
      if (!Array.isArray(data) && typeof data == 'object') {
        ...
        if (
          'feedback_to_interviewee' in data &&
          data.feedback_to_interviewee != undefined
        ) {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.duration !== undefined) writer.writeInt32(3, this.duration);
      ...
      if (this.is_solved !== undefined) writer.writeBool(9, this.is_solved);
      if (
        typeof this.feedback_to_interviewee === 'string' &&
        this.feedback_to_interviewee.length
      )
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new CreateMeetingRequest();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
    ...
    static override deserializeBinary(bytes: Uint8Array): CreateMeetingRequest {
  ...
  export class CreateRatingRequest extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.rating !== undefined) writer.writeInt32(1, this.rating);
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new CreateRatingRequest();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
    ...
    static override deserializeBinary(bytes: Uint8Array): CreateRatingRequest {
  ...
  export class GetUserRequest extends pb_1.Message {
    ...
    static fromObject(data: { uid?: string }) {
  ...
  export class AuthResponse extends pb_1.Message {
    ...
    static override deserializeBinary(bytes: Uint8Array): AuthResponse {
  ...
  export class ClientRequest extends pb_1.Message {
    constructor(
      ...
      if (!Array.isArray(data) && typeof data == 'object') {
        if (
          'join_room_request' in data &&
          data.join_room_request != undefined
        ) {
          this.join_room_request = data.join_room_request;
        }
        if (
          'complete_question_request' in data &&
          data.complete_question_request != undefined
        ) {
          this.complete_question_request = data.complete_question_request;
        }
        if (
          'submit_rating_request' in data &&
          data.submit_rating_request != undefined
        ) {
          this.submit_rating_request = data.submit_rating_request;
        }
        if (
          'leave_room_request' in data &&
          data.leave_room_request != undefined
        ) {
    ...
    static fromObject(data: {
      ...
      complete_question_request?: ReturnType<
        typeof CompleteQuestionRequest.prototype.toObject
      >;
      submit_rating_request?: ReturnType<
        typeof SubmitRatingRequest.prototype.toObject
      >;
      leave_room_request?: ReturnType<
        typeof LeaveRoomRequest.prototype.toObject
      >;
    }) {
      const message = new ClientRequest({});
      if (data.join_room_request != null) {
        message.join_room_request = JoinRoomRequest.fromObject(
          data.join_room_request,
        );
      }
      if (data.complete_question_request != null) {
        message.complete_question_request = CompleteQuestionRequest.fromObject(
          data.complete_question_request,
        );
      }
      if (data.submit_rating_request != null) {
        message.submit_rating_request = SubmitRatingRequest.fromObject(
          data.submit_rating_request,
        );
      }
      if (data.leave_room_request != null) {
        message.leave_room_request = LeaveRoomRequest.fromObject(
          data.leave_room_request,
        );
      }
      return message;
    }
    toObject() {
      const data: {
        join_room_request?: ReturnType<
          typeof JoinRoomRequest.prototype.toObject
        >;
        complete_question_request?: ReturnType<
          typeof CompleteQuestionRequest.prototype.toObject
        >;
      ...
      if (this.complete_question_request != null) {
        data.complete_question_request =
          this.complete_question_request.toObject();
      }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.join_room_request !== undefined)
        writer.writeMessage(1, this.join_room_request, () =>
          this.join_room_request.serialize(writer),
        );
      if (this.complete_question_request !== undefined)
        writer.writeMessage(2, this.complete_question_request, () =>
          this.complete_question_request.serialize(writer),
        );
      if (this.submit_rating_request !== undefined)
        writer.writeMessage(3, this.submit_rating_request, () =>
          this.submit_rating_request.serialize(writer),
        );
      if (this.leave_room_request !== undefined)
        writer.writeMessage(4, this.leave_room_request, () =>
          this.leave_room_request.serialize(writer),
        );
      if (!w) return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ClientRequest {
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new ClientRequest();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
            reader.readMessage(
              message.join_room_request,
              () =>
                (message.join_room_request =
                  JoinRoomRequest.deserialize(reader)),
            );
            break;
          case 2:
            reader.readMessage(
              message.complete_question_request,
              () =>
                (message.complete_question_request =
                  CompleteQuestionRequest.deserialize(reader)),
            );
            break;
          case 3:
            reader.readMessage(
              message.submit_rating_request,
              () =>
                (message.submit_rating_request =
                  SubmitRatingRequest.deserialize(reader)),
            );
            break;
          case 4:
            reader.readMessage(
              message.leave_room_request,
              () =>
                (message.leave_room_request =
                  LeaveRoomRequest.deserialize(reader)),
            );
            break;
          default:
            reader.skipField();
    ...
    static override deserializeBinary(bytes: Uint8Array): ClientRequest {
  ...
  export class RoomServiceToClientMessage extends pb_1.Message {
    constructor(
      ...
      if (!Array.isArray(data) && typeof data == 'object') {
        if (
          'join_room_response' in data &&
          data.join_room_response != undefined
        ) {
          this.join_room_response = data.join_room_response;
        }
        if (
          'join_room_broadcast' in data &&
          data.join_room_broadcast != undefined
        ) {
          this.join_room_broadcast = data.join_room_broadcast;
        }
        if (
          'disconnect_broadcast' in data &&
          data.disconnect_broadcast != undefined
        ) {
          this.disconnect_broadcast = data.disconnect_broadcast;
        }
        if (
          'complete_question_response' in data &&
          data.complete_question_response != undefined
        ) {
          this.complete_question_response = data.complete_question_response;
        }
        if (
          'submit_rating_response' in data &&
          data.submit_rating_response != undefined
        ) {
          this.submit_rating_response = data.submit_rating_response;
        }
        if (
          'leave_room_response' in data &&
          data.leave_room_response != undefined
        ) {
          this.leave_room_response = data.leave_room_response;
        }
        if (
          'leave_room_broadcast' in data &&
          data.leave_room_broadcast != undefined
        ) {
    ...
    static fromObject(data: {
      join_room_response?: ReturnType<
        typeof JoinRoomResponse.prototype.toObject
      >;
      join_room_broadcast?: ReturnType<
        typeof JoinRoomBroadcast.prototype.toObject
      >;
      disconnect_broadcast?: ReturnType<
        typeof DisconnectBroadcast.prototype.toObject
      >;
      complete_question_response?: ReturnType<
        typeof CompleteQuestionResponse.prototype.toObject
      >;
      submit_rating_response?: ReturnType<
        typeof SubmitRatingResponse.prototype.toObject
      >;
      leave_room_response?: ReturnType<
        typeof LeaveRoomResponse.prototype.toObject
      >;
      ...
      if (data.join_room_response != null) {
        message.join_room_response = JoinRoomResponse.fromObject(
          data.join_room_response,
        );
      }
      if (data.join_room_broadcast != null) {
        message.join_room_broadcast = JoinRoomBroadcast.fromObject(
          data.join_room_broadcast,
        );
      }
      if (data.disconnect_broadcast != null) {
        message.disconnect_broadcast = DisconnectBroadcast.fromObject(
          data.disconnect_broadcast,
        );
      }
      if (data.complete_question_response != null) {
        message.complete_question_response =
          CompleteQuestionResponse.fromObject(data.complete_question_response);
      }
      if (data.submit_rating_response != null) {
        message.submit_rating_response = SubmitRatingResponse.fromObject(
          data.submit_rating_response,
        );
      }
      if (data.leave_room_response != null) {
        message.leave_room_response = LeaveRoomResponse.fromObject(
          data.leave_room_response,
        );
      }
      if (data.leave_room_broadcast != null) {
        message.leave_room_broadcast = LeaveRoomBroadcast.fromObject(
    ...
    toObject() {
      ...
      if (this.complete_question_response != null) {
        data.complete_question_response =
          this.complete_question_response.toObject();
      }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.join_room_response !== undefined)
        writer.writeMessage(1, this.join_room_response, () =>
          this.join_room_response.serialize(writer),
        );
      if (this.join_room_broadcast !== undefined)
        writer.writeMessage(2, this.join_room_broadcast, () =>
          this.join_room_broadcast.serialize(writer),
        );
      if (this.disconnect_broadcast !== undefined)
        writer.writeMessage(3, this.disconnect_broadcast, () =>
          this.disconnect_broadcast.serialize(writer),
        );
      if (this.complete_question_response !== undefined)
        writer.writeMessage(4, this.complete_question_response, () =>
          this.complete_question_response.serialize(writer),
        );
      if (this.submit_rating_response !== undefined)
        writer.writeMessage(5, this.submit_rating_response, () =>
          this.submit_rating_response.serialize(writer),
        );
      if (this.leave_room_response !== undefined)
        writer.writeMessage(6, this.leave_room_response, () =>
          this.leave_room_response.serialize(writer),
        );
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new RoomServiceToClientMessage();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
            reader.readMessage(
              ...
              () =>
                (message.join_room_response =
                  JoinRoomResponse.deserialize(reader)),
            );
            break;
          case 2:
            reader.readMessage(
              message.join_room_broadcast,
              () =>
                (message.join_room_broadcast =
                  JoinRoomBroadcast.deserialize(reader)),
            );
            break;
          case 3:
            reader.readMessage(
              message.disconnect_broadcast,
              () =>
                (message.disconnect_broadcast =
                  DisconnectBroadcast.deserialize(reader)),
            );
            break;
          case 4:
            reader.readMessage(
              ...
              () =>
                (message.complete_question_response =
                  CompleteQuestionResponse.deserialize(reader)),
            );
            break;
          case 5:
            reader.readMessage(
              message.submit_rating_response,
              () =>
                (message.submit_rating_response =
                  SubmitRatingResponse.deserialize(reader)),
            );
            break;
          case 6:
            reader.readMessage(
              ...
              () =>
                (message.leave_room_response =
                  LeaveRoomResponse.deserialize(reader)),
            );
            break;
          case 7:
            reader.readMessage(
              message.leave_room_broadcast,
              () =>
                (message.leave_room_broadcast =
  ...
  export class JoinRoomRequest extends pb_1.Message {
    ...
    static override deserializeBinary(bytes: Uint8Array): JoinRoomRequest {
  ...
  export class JoinRoomResponse extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.paired_user !== undefined)
        writer.writeMessage(5, this.paired_user, () =>
          this.paired_user.serialize(writer),
        );
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 5:
            reader.readMessage(
              message.paired_user,
              () => (message.paired_user = User.deserialize(reader)),
            );
            break;
          case 6:
    ...
    static override deserializeBinary(bytes: Uint8Array): JoinRoomResponse {
  ...
  export class JoinRoomBroadcast extends pb_1.Message {
    ...
    static fromObject(data: { joined_uid?: string }) {
    ...
    static override deserializeBinary(bytes: Uint8Array): JoinRoomBroadcast {
  ...
  export class DisconnectBroadcast extends pb_1.Message {
    ...
    static fromObject(data: { disconnected_uid?: string }) {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (
        typeof this.disconnected_uid === 'string' &&
        this.disconnected_uid.length
      )
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new DisconnectBroadcast();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
    ...
    static override deserializeBinary(bytes: Uint8Array): DisconnectBroadcast {
  ...
  export class CompleteQuestionRequest extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (typeof this.room_id === 'string' && this.room_id.length)
        writer.writeString(1, this.room_id);
      if (this.is_solved !== undefined) writer.writeBool(2, this.is_solved);
      if (
        typeof this.feedback_to_interviewee === 'string' &&
        this.feedback_to_interviewee.length
      )
      ...
      if (this.language !== undefined) writer.writeEnum(5, this.language);
      if (!w) return writer.getResultBuffer();
    }
    static deserialize(
      bytes: Uint8Array | pb_1.BinaryReader,
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new CompleteQuestionRequest();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  export class CompleteQuestionResponse extends pb_1.Message {
    constructor(
      ...
      if (!Array.isArray(data) && typeof data == 'object') {
        ...
        if ('next_question_id' in data && data.next_question_id != undefined) {
          this.next_question_id = data.next_question_id;
        }
        if (
          'is_interview_completed' in data &&
          data.is_interview_completed != undefined
        ) {
    ...
    set next_question_id(value: string) {
      pb_1.Message.setField(this, 4, value);
    }
    ...
    static fromObject(data: {
      ...
      if (data.next_question_id != null) {
        message.next_question_id = data.next_question_id;
      }
    ...
    toObject() {
      ...
      if (this.next_question_id != null) {
        data.next_question_id = this.next_question_id;
      }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (typeof this.interviewer_id === 'string' && this.interviewer_id.length)
        writer.writeString(3, this.interviewer_id);
      if (
        typeof this.next_question_id === 'string' &&
        this.next_question_id.length
      )
        writer.writeString(4, this.next_question_id);
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new CompleteQuestionResponse();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
          ...
          case 3:
            ...
            break;
          case 4:
            message.next_question_id = reader.readString();
            break;
          case 5:
  ...
  export class SubmitRatingRequest extends pb_1.Message {
    ...
    static fromObject(data: { room_id?: string; rating?: number }) {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (typeof this.room_id === 'string' && this.room_id.length)
        writer.writeString(1, this.room_id);
      if (this.rating !== undefined) writer.writeInt32(2, this.rating);
      if (!w) return writer.getResultBuffer();
    }
    static deserialize(
      bytes: Uint8Array | pb_1.BinaryReader,
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new SubmitRatingRequest();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
    ...
    static override deserializeBinary(bytes: Uint8Array): SubmitRatingRequest {
  ...
  export class SubmitRatingResponse extends pb_1.Message {
    ...
    static fromObject(data: { error_code?: number }) {
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new SubmitRatingResponse();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
    ...
    static override deserializeBinary(bytes: Uint8Array): SubmitRatingResponse {
  ...
  export class LeaveRoomRequest extends pb_1.Message {
    ...
    static override deserializeBinary(bytes: Uint8Array): LeaveRoomRequest {
  ...
  export class LeaveRoomResponse extends pb_1.Message {
    ...
    static override deserializeBinary(bytes: Uint8Array): LeaveRoomResponse {
  ...
  export class LeaveRoomBroadcast extends pb_1.Message {
    ...
    static fromObject(data: { left_uid?: string }) {
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new LeaveRoomBroadcast();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
    ...
    static override deserializeBinary(bytes: Uint8Array): LeaveRoomBroadcast {
